...
async function createNotificationForMobileUser() {
    try {
        console.log('🔔 Creating Notification for Mobile App User');
        ...
        // Step 1: Create the mobile app user if it doesn't exist
        console.log('\n👤 Step 1: Creating mobile app user...');
        
        let mobileUser = await User.findById(MOBILE_USER_ID);
        
        if (!mobileUser) {
            console.log('⚠️ Mobile app user not found. Creating new user...');
            
            mobileUser = new User({
                _id: MOBILE_USER_ID, // Use the exact ID from mobile app
                name: 'Shivam Gupta',
            ...
            console.log('✅ Created mobile app user with exact ID');
        } else {
            console.log('✅ Mobile app user found');
            console.log(`   Name: ${mobileUser.name}`);
            console.log(`   Email: ${mobileUser.email}`);
            console.log(`   Skills: ${mobileUser.skills_and_capabilities?.join(', ') || 'No skills'}`);
            
            // Update skills if needed
            if (!mobileUser.skills_and_capabilities || mobileUser.skills_and_capabilities.length === 0) {
                mobileUser.skills_and_capabilities = ['React', 'JavaScript', 'TypeScript', 'Node.js', 'MongoDB', 'Express.js', 'Frontend Development', 'Web Development'];
                await mobileUser.save();
        ...
        // Step 3: Create notification for the mobile app user
        console.log('\n🔔 Step 3: Creating notification for mobile app user...');
        ...
        console.log('\n🔍 Step 4: Verifying notification creation...');
        ...
        // Step 5: Test API call to verify it works
        ...
        console.log('\n' + '='.repeat(50));
        console.log('🏁 Mobile user notification creation completed!');
...
createNotificationForMobileUser(); 