...
export const createAccount = async (req, res) => {
  ...
  try {
    ...
    if (!employer.companyName || typeof employer.companyName !== "string") {
    ...
    employer.companyEmployerId = `${employer.companyName
      .replace(/\s+/g, "")
...
export const updateProfile = async (req, res) => {
  try {
    // Use req.employer._id as set by protectEmployer middleware
